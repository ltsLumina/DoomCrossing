...
public class Magazine : MonoBehaviour
{
    ...
    public void ReloadMagazine()
    {
        ...
        Sequence ammoSeq = new Sequence(this);
        ammoSeq.Execute(UpdateAmmoText).WaitForSeconds(0.75f).ContinueWith
        (() =>
        {
    ...
    {
        ammoText.text = currentMagCount.ToString(CultureInfo.InvariantCulture);
    }
